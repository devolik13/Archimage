...
function setupGeneratorUI() {
    ...
    const cardsHTML = `
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; flex: 1;">
            <!-- ПРОИЗВОДСТВО -->
            <div style="background: linear-gradient(135deg, #4ade80 0%, #3d9b68 100%); padding: 10px; border-radius: 8px; display: flex; flex-direction: column; justify-content: space-between;">
                <div style="text-align: center;">
                    <span style="font-size: ${titleFontSize}px;">⚡</span>
                    <h4 style="margin: 4px 0; color: white; font-size: ${smallFontSize}px; font-weight: bold;">Производство</h4>
                </div>
                <div style="font-size: ${titleFontSize * 1.2}px; color: white; text-align: center; font-weight: bold;">
                    +${production}
                </div>
                <div style="font-size: ${smallFontSize * 0.8}px; color: rgba(255,255,255,0.9); text-align: center;">
                    мин/час
                </div>
                ${generatorLevel < maxGeneratorLevel ? `
                    <div style="font-size: ${smallFontSize * 0.7}px; color: rgba(255,255,255,0.8); text-align: center; margin-top: 4px; padding: 3px; background: rgba(0,0,0,0.2); border-radius: 4px;">
            ...
            <!-- ХРАНИЛИЩЕ -->
            <div style="background: linear-gradient(135deg, #00bcd4 0%, #0097a7 100%); padding: 10px; border-radius: 8px; display: flex; flex-direction: column; justify-content: space-between;">
                <div style="text-align: center;">
                    <span style="font-size: ${titleFontSize}px;">📦</span>
                    <h4 style="margin: 4px 0; color: white; font-size: ${smallFontSize}px; font-weight: bold;">Хранилище</h4>
                </div>
                <div style="font-size: ${titleFontSize}px; color: white; text-align: center; font-weight: bold;">
            ...
            <!-- ЗАПОЛНЕНИЕ -->
            <div style="background: linear-gradient(135deg, #ffa500 0%, #ff8c00 100%); padding: 10px; border-radius: 8px; display: flex; flex-direction: column; justify-content: space-between;">
                <div style="text-align: center;">
                    <span style="font-size: ${titleFontSize}px;">⏰</span>
                    <h4 style="margin: 4px 0; color: white; font-size: ${smallFontSize}px; font-weight: bold;">Заполнение</h4>
                </div>
                <div style="font-size: ${titleFontSize}px; color: white; text-align: center; font-weight: bold;">
                    ${timeToFullText}
                </div>
