...
const PRODUCTS: Record<string, { title: string; description: string; price: number; type: string; amount?: number }> = {
  ...
  starter_pack_small: {
    ...
    description: "7 дней времени, Башня 3 ур, 2-й маг, 5000 XP",
    price: 2900,
    type: "starter_pack"
  },
  starter_pack_medium: {
    title: "📦 Средний стартовый пакет",
    description: "30 дней времени, Башня 5 ур, 3-й маг, 30000 XP",
    price: 10400,
    type: "starter_pack"
  },
  starter_pack_large: {
    title: "💎 Крупный стартовый пакет",
    description: "90 дней времени, Башня 7 ур, 4-й маг, 200000 XP",
    price: 40000,
    type: "starter_pack"
  },
  ...
  faction_change: {
    ...
    price: 280, // Минимальная цена, реальная передаётся в запросе
    type: "faction_change"
  }
};
