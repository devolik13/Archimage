...
Твой прогресс сохраняется автоматически, ничего не потеряется!`
                ...
                {
                    title: 'Как работает сопротивление магии?',
                    content: `<b>Сопротивление магии</b> — снижает входящий урон определённой школы.

<b>Откуда берётся:</b>
• 📖 Каждый уровень изученного заклинания даёт <b>+1.5%</b> сопротивления к своей школе
• 🔀 Гибридные заклинания дают <b>+0.5%</b> за уровень к каждой из своих школ
• 🏰 Бонусы гильдии добавляют дополнительный % сопротивления

<b>Как применяется:</b>
• Максимум — <b>75%</b> снижения урона (потолок)
• Минимальный урон всегда равен <b>1</b> (нельзя снизить до нуля)
• Для гибридных заклинаний — берётся среднее сопротивление по школам

<b>Порядок расчёта урона:</b>
1. Базовый урон заклинания
2. Баффы и дебаффы (благословения, Рассвет, тьма)
3. ⭐ <b>Сопротивление магии</b>
4. Радужный щит
5. Броня

<b>Совет:</b> Прокачивай заклинания разных школ — это повышает твою защиту от них!`
                },
                {
