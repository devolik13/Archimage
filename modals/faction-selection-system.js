...
const FACTION_DESCRIPTIONS = {
    ...
    water: {
        ...
        bonus: "При водных атаках уровней 1-4: 15% шанс охладить врага (-15% урона). На уровне 5: 15% шанс заморозить (-20% урона).\n\n📚 Заклинания школы Воды изучаются на 15% быстрее."
    },
    wind: {
        name: "💨 ВЕТЕР",
    ...
    light: {
        name: "✨ СВЕТ",
        description: "Священная сила защиты и усиления. Маги света ослепляют врагов сиянием солнца, укрепляют союзников радужными щитами и усиливают всю команду рассветной магией. Лучи света пронзают любую защиту.",
        bonus: "После применения любого заклинания 5% шанс снять один дебафф (горение, яд, заморозку, ослепление) со случайного союзника.\n\n📚 Заклинания школы Света изучаются на 15% быстрее."
    },
    dark: {
        name: "🌑 ТЬМА",
        description: "Запретная магия ослабления и разложения. Маги тьмы накладывают слабость на врагов, разъедают их броню сгустками тьмы и обрушивают мир теней на раненых противников. Чем дольше бой — тем сильнее тьма.",
        bonus: "После атаки по врагам 10% шанс снять 5 единиц брони со всех задетых целей.\n\n📚 Заклинания школы Тьмы изучаются на 15% быстрее."
    },
    necromant: {
        name: "💀 НЕКРОМАНТИЯ",
        description: "Власть над жизнью и смертью. Некроманты призывают нежить, пронзают врагов костяными копьями и окутывают поле боя покровом смерти. Мёртвые сражаются за них.",
        bonus: "При убийстве вражеского мага 15% шанс призвать скелета на его место. Скелет сражается на вашей стороне до конца боя.\n\n📚 Заклинания школы Некромантии изучаются на 15% быстрее."
    }
};
...
window.FactionSelection = {
    circles: {
        ...
        light:    { x: 432, y: 317, radius: 50, active: true },
        dark:     { x: 560, y: 317, radius: 50, active: true },
        necromant:{ x: 681, y: 317, radius: 50, active: true }
    },
