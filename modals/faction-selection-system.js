...
const FACTION_DESCRIPTIONS = {
    ...
    light: {
        name: "✨ СВЕТ",
        description: "Священная сила исцеления и защиты. Маги света оберегают союзников божественными щитами и карают нечестивых ослепительными лучами. Поддержка и возмездие.",
        bonus: "При исцелении союзника 10% шанс наложить щит, поглощающий 10% от максимального HP. Святой свет ослепляет врагов, снижая точность на 15%.\n\n📚 Заклинания школы Света изучаются на 15% быстрее."
    },
    dark: {
        name: "🌑 ТЬМА",
        description: "Запретная магия теней и проклятий. Маги тьмы высасывают жизненную силу врагов и призывают существ из бездны. Сила любой ценой.",
        bonus: "При атаке тьмой 10% шанс похитить 5% от нанесённого урона в виде здоровья. Проклятия снижают защиту врага на 10% на 2 хода.\n\n📚 Заклинания школы Тьмы изучаются на 15% быстрее."
    }
};
