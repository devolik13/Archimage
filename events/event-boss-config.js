 ...
 * Во время ивента добыча времени у всех -30% (ослаблено Архимагом Света).
 * Босс ослаблен: входящий урон +90% (incomingDamageMultiplier: 1.9).
 * Победа (босс убит) → +35% добычи следующую неделю.
...
const EVENT_BOSS_CONFIG = {
    ...
    // 1.9 = босс получает на 90% больше урона
    incomingDamageMultiplier: 1.9,
    ...
    timeCurrencyModifier: {
        ...
        duringEvent: -0.30,        // -30% во время ивента (ослаблено Архимагом Света)
        onVictory: 0.35,          // +35% если игроки победили
