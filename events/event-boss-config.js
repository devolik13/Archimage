 ...
 * Во время ивента добыча времени у всех -40% (проклятие Отродья Тьмы).
 * Босс ослаблен: входящий урон +120% (incomingDamageMultiplier: 2.2).
...
const EVENT_BOSS_CONFIG = {
    ...
    // 2.2 = босс получает на 120% больше урона
    incomingDamageMultiplier: 2.2,
    ...
    timeCurrencyModifier: {
        ...
        duringEvent: -0.40,        // -40% во время ивента (проклятие Отродья Тьмы)
