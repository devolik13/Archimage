...
(function() {
    ...
    const FACTION_SPRITES_CONFIG = {
        ...
        light: {
            idle: 'images/wizards/light/idle.webp',
            cast: 'images/wizards/light/cast.webp',
            death: 'images/wizards/light/death.webp',
            frameWidth: 256,
            frameHeight: 256,
            frameCount: 25, // 5×5 сетка (1280×1280)
            gridColumns: 5,
        ...
        private_roman: {
            idle: 'images/wizards/neutral/private_roman_idle.webp',
            cast: 'images/wizards/neutral/private_roman_cast.webp',
            death: 'images/wizards/neutral/private_roman_death.webp',
            frameWidth: 256,
            frameHeight: 256,
            frameCount: 25, // 5×5 сетка
            gridColumns: 5,
        ...
        spawn_of_darkness: {
            ...
            scale: 1.0 // 2x крупнее всех — это ивент босс
        }
    };
