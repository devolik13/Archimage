...
const SCHOOL_CONFIG = {
    ...
    "necromant": {
        ...
        emoji: "💀",
        color: "#708090",
        description: "Тёмное искусство поднятия мёртвых. Маги-некроманты получают на 10% меньше урона от всех школ кроме Света.",
        strengths: ["Сопротивление урону", "Призыв нежити"],
        weaknesses: ["Уязвимость к Свету"],
        battlefieldColor: "rgba(112, 128, 144, 0.2)"
    }
};
