...
window.BATTLE_ENERGY = {
    MAX: 24,                    // Максимум попыток
    REGEN_TIME: 60,             // Минут на 1 попытку (1 час)
    REGEN_TIME_MS: 60 * 60000   // В миллисекундах
};
...
window.CONSTRUCTION_TIME = {
    ...
    buildingSpeedMultiplier: {
        ...
        time_generator: 0.5   // 248 дней до макс уровня 20
    },
...
window.WIZARD_HIRE_TIME = {
    getHireTime: function(wizardCount) {
        // Мгновенный найм для всех магов
        return 0;
    }
};