-- Migration 021: Fix guild fields in update_player_safe
-- Adds guild_id, guild_contribution, guild_last_active to the RPC function
...
BEGIN
    ...
    SET
        ...
        guild_last_active = CASE
            ...
            WHEN p_data ? 'guild_last_active' AND p_data->>'guild_last_active' IS NULL
            THEN NULL
...
COMMENT ON FUNCTION update_player_safe(bigint, jsonb) IS 'Безопасное обновление данных игрока. Включает поля гильдии (guild_id, guild_contribution, guild_last_active).';
