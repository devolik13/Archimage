-- Migration: Add airdrop_history field
-- Date: 2025-12-10
-- Description: Add field to store airdrop points earning history

-- Add airdrop_history column as JSONB array
ALTER TABLE players ADD COLUMN IF NOT EXISTS airdrop_history JSONB DEFAULT '[]';

-- Update RPC function to handle airdrop_history
...
BEGIN
    ...
    SET
        ...
        airdrop_history = COALESCE(p_data->'airdrop_history', airdrop_history),
...
-- Комментарий
COMMENT ON COLUMN players.airdrop_history IS 'JSONB array storing history of airdrop points earnings';
