-- Migration 038: Fix airdrop_points blocking all saves
-- Problem: RAISE EXCEPTION on airdrop_points decrease blocks ALL player saves
--          (including wizards XP, battle_energy, etc.)
-- Solution: Use GREATEST() to silently keep the higher value instead of throwing
